...
export type ResolversTypes = ResolversObject<{
  ...
  Tag__Mutation: ResolverTypeWrapper<Tag__Mutation>;
}>;
...
> = ResolversObject<{
  soe?: Resolver<Maybe<ResolversTypes["String"]>, ParentType, ContextType>;
}>;
